...
" ---- Copied from vim tips wiki:
"    http://vim.wikia.com/wiki/Deleting_a_buffer_without_closing_the_window
" ---- Script to add :Bclose to close a buffer while maintaining a split.
...
" ------------ END BCLOSE FROM VIM TIPS WIKI -------------


" Custom mapping to above defined :Bclose method
